...
public class CollegeModel {
	...
	public void add(CollegeBean bean) throws SQLException, DuplicateRecordException {
	...
	public void update(CollegeBean bean) throws SQLException, DuplicateRecordException {
